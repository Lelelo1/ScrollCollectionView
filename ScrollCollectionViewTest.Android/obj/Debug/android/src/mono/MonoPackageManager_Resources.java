...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ScrollCollectionViewTest.Android.dll" comes first in this list. */
		"ScrollCollectionViewTest.Android.dll",
		"FormsViewGroup.dll",
		"NObservable.dll",
		"ScrollCollectionViewTest.dll",
